...
class Ray : public Personaje{   
	...
	float duracionFrame = 0.1f; // Duración de cada frame en segundos
	...
	int MAX_ENERGIA = 100; // Declaración de la constante dentro de la clase
	...
	int getBastonEnergia() { return bastonEnergia; } // Método para obtener la energía
	int getMaxEnergia()  { return MAX_ENERGIA; } // Nuevo método para obtener MAX_ENERGIA
